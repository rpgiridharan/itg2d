...
plt.legend()
plt.tight_layout()
plt.savefig(datadir+'zonal_energy_frac_vs_kapt_sweep.png',dpi=100)
plt.show()
...
# plt.legend()
# plt.tight_layout()
# plt.savefig(datadir+'zonal_enstrophy_frac_vs_kapt_sweep.png',dpi=100)
# plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig(datadir+'Q_vs_kapt_sweep.png',dpi=100)
plt.show()
