...
if(wecontinue):
    ...
    save_data(fl,'params',ext_flag=False,Npx=Npx,Npy=Npy,Lx=Lx,Ly=Ly,kapn=kapn,kapt=kapt,kapb=kapb,chi=chi,a=a,b=b,s=s,kz=0.1,HP=HP,HPhi=HPhi,HV=HV,gammax=gammax)
